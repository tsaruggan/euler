...
struct Input {
    ...
    static let symbols = [
        ...
        Symbol("ε", "lowercase epsilon", "vacuum permittivity of free space"),
        Symbol("ζ", "lowercase zeta"),
        Symbol("η", "lowercase eta"),
        Symbol("θ", "lowercase theta"),
        Symbol("ι", "lowercase iota"),
        Symbol("κ", "lowercase kappa", "einstein gravitational constant"),
        ...
        Symbol("ρ", "lowercase rho", "correlation"),
        Symbol("σ", "lowercase sigma", "standard deviation", "covariance"),
        Symbol("ς", "lowercase sigma"),
        Symbol("τ", "lowercase tau"),
        Symbol("υ", "lowercase upsilon"),
        Symbol("φ", "lowercase phi", "golden ratio"),
        ...
        Symbol("Δ", "uppercase delta", "laplace operator", "change"),
        ...
        Symbol("Σ", "uppercase sigma", "sum"),
        Symbol("Τ", "uppercase tau"),
        Symbol("Υ", "uppercase upsilon"),
        Symbol("Φ", "uppercase phi", "golden ratio"),
        Symbol("Χ", "uppercase chi"),
        Symbol("Ψ", "uppercase psi"),
        Symbol("Ω", "uppercase omega"),
        Symbol("+", "plus sign", "add"),
        Symbol("−", "minus sign", "subtract"),
        Symbol("×", "multiplication sign", "multiply", "cross product"),
        Symbol("÷", "division sign", "divide"),
        Symbol("=", "equals sign"),
        Symbol("≠", "not equal to", "neq", "inequality"),
        Symbol("±", "plus minus symbol", "+/-"),
        Symbol("⊕", "circled plus", "+", "direct sum", "exclusive or", "xor", "oplus", "biproduct"),
        Symbol("⊖", "circled minus", "-"),
        Symbol("⊗", "circled times", "×", "tensor product", "dyadic product", "otimes", "kronecker product"),
        Symbol("⊘", "circled division slash", "hadamard division", "oslash"),
        Symbol("⊙", "circled dot operator", "hadamard product"),
        Symbol("⊚", "circled ring operator"),
        Symbol("⊛", "circled asterisk operator"),
        Symbol("⊝", "circled dash", "minus", "-", "symmetric difference", "ominus"),
        Symbol("⊞", "squared plus"),
        Symbol("⊟", "squared minus"),
        Symbol("⊠", "squared times"),
        Symbol("⊡", "squared dot operator"),
        Symbol("∏", "n-ary product", "repeated multiplication", "pi"),
        Symbol("∐", "n-ary coproduct", "pi"),
        Symbol("∑", "n-ary summation", "sigma", "repeated addition"),
        Symbol("∓", "minus-or-plus sign", "monus", "-/+"),
        Symbol("∔", "dot plus"),
        Symbol("∖", "set minus"),
        Symbol("∗", "asterisk operator", "multiply"),
        Symbol("∘", "ring operator", "of", "function composition", "hadamard product"),
        Symbol("√", "square root", "root 2"),
        Symbol("∛", "cubic root", "root 3", "cube"),
        Symbol("∜", "fourth root", "root 4", "quartic"),
        Symbol("¬", "not sign", "lnot", "negation"),
        Symbol("∧", "logical and", "caret", "^", "&", "wedge", "conjunction", "land"),
        Symbol("∨", "logical or", "|", "vee", "disjunction", "lor"),
        Symbol("∀", "for all", "universal quantification"),
        Symbol("∃", "there exists", "existential quantifier"),
        Symbol("∄", "there does not exist", "existential quantifier"),
        Symbol("∅", "empty set", "varnothing"),
        Symbol("∩", "intersection", "cap"),
        Symbol("∪", "union", "cup"),
        Symbol("∈", "element of", "in", "isin"),
        Symbol("∉", "not an element of", "not in", "notin"),
        Symbol("∋", "contains as member", "such that", "ni"),
        Symbol("∌", "does not contain as member"),
        Symbol("∁", "complement"),
        Symbol("%", "percent sign", "modulo", "modulus"),
        Symbol("‱", "per ten thousand sign"),
        Symbol("∫", "integral"),
        Symbol("∬", "double integral"),
        Symbol("∭", "triple integral"),
        Symbol("∮", "contour integral", "closed integral"),
        Symbol("∯", "surface integral", "double closed integral"),
        Symbol("∰", "volume integral", "triple closed integral"),
        Symbol("∱", "clockwise integral"),
        Symbol("∲", "clockwise contour integral"),
        Symbol("∳", "anticlockwise contour integral"),
        Symbol("∇", "nabla", "gradient operator", "laplace", "curl"),
        Symbol("∂", "partial differential", "vector derivative"),
        Symbol("∴", "therefore", "dots"),
        Symbol("∵", "because", "dots"),
        Symbol("∶", "ratio", "colon"),
        Symbol("∷", "proportion"),
        Symbol("∸", "dot minus"),
        ...
        Symbol("∻", "homothetic"),
        Symbol("∼", "tilde operator", "probability distribution", "sim"),
        Symbol("≁", "not tilde"),
        Symbol("≂", "minus tilde"),
        ...
        Symbol("≈", "almost equal to", "tilde equal", "approximately"),
        ...
        Symbol("≐", "approaches the limit", "approximately equal to", "doteq"),
        Symbol("≑", "geometrically equal to"),
        Symbol("≒", "approximately equal to or the image of"),
        Symbol("≓", "image of or approximately equal to"),
        Symbol("≔", "colon equals", "coloneq", "assignment", "definition"),
        Symbol("≕", "equals colon", "eqcolon", "assignment", "definition"),
        Symbol("≖", "ring in equal to"),
        Symbol("≗", "ring equal to"),
        Symbol("≙", "estimates", "bijection", "wedgeq"),
        Symbol("≚", "equiangular to"),
        Symbol("≜", "delta equal to", "triangleq", "trie"),
        Symbol("≟", "questioned equal to", "is it equal to", "questeq"),
        Symbol("≡", "identical to", "equivalent to", "identity", "equiv"),
        Symbol("≢", "not identical to", "not equivalent to", "neq"),
        Symbol("<", "less-than sign"),
        Symbol(">", "greater-than sign"),
        Symbol("≤", "less-than or equal to", "leq"),
        Symbol("≥", "greater-than or equal to", "geq"),
        ...
        Symbol("≮", "not less-than", "nless"),
        Symbol("≯", "not greater-than", "ngtr"),
        Symbol("≰", "neither less-than nor equal to", "nleq"),
        Symbol("≱", "neither greater-than nor equal to", "ngeq"),
        Symbol("≲", "less-than or equivalent to", "lesssim"),
        Symbol("≳", "greater-than or equivalent to", "gtrsim"),
        ...
        Symbol("≺", "precedes", "prec"),
        Symbol("≻", "succeeds", "succ"),
        Symbol("≼", "precedes or equal to", "preccurlyeq"),
        Symbol("≽", "succeeds or equal to", "succcurlyeq"),
        Symbol("≾", "precedes or equivalent to", "precsim"),
        Symbol("≿", "succeeds or equivalent to", "succsim"),
        Symbol("⊀", "does not precede"),
        Symbol("⊁", "does not succeed"),
        Symbol("⊂", "subset of"),
        Symbol("⊃", "superset of"),
        Symbol("⊄", "not a subset of", "nsub"),
        Symbol("⊅", "not a superset of", "nsup"),
        Symbol("⊆", "subset of or equal to", "subseteq"),
        Symbol("⊇", "superset of or equal to", "supseteq"),
        Symbol("⊈", "neither a subset of nor equal to"),
        Symbol("⊉", "neither a superset of nor equal to"),
        Symbol("⊊", "subset of with not equal to", "subsetneq"),
        Symbol("⊋", "superset of with not equal to", "supsetneq"),
        Symbol("⊍", "multiset multiplication", "cupdot", "disjoint union"),
        Symbol("⊎", "multiset union", "uplus", "disjoint union"),
        Symbol("⊏", "square image of", "sqsubset"),
        Symbol("⊐", "square original of", "sqsupset"),
        Symbol("⊑", "square image of or equal to", "sqsubseteq"),
        Symbol("⊒", "square original of or equal to", "sqsupseteq"),
        Symbol("⊓", "square cap", "squareintersection", "intersection"),
        Symbol("⊔", "square cup", "disjoint union", "squareunion"),
        Symbol("⊢", "right tack", "vdash", "consequence"),
        Symbol("⊣", "left tack"),
        Symbol("⊤", "down tack", "top", "tautology"),
        Symbol("⊥", "up tack", "probability independance", "contradiction", "bot", "perp", "perpendicular", "orthogonality"),
        Symbol("⊧", "models"),
        Symbol("⊨", "true", "models", "consequence", "inference"),
        Symbol("⊩", "forces"),
        ...
        Symbol("⋂", "n-ary intersection", "bigcap"),
        Symbol("⋃", "n-ary union", "bigcup"),
